...
git clone --depth=1 https://github.com/$USERNAME/Ruega-Kernel-X00T -b 9x13 kernel
...
ZIPNAME="TheOneMemory"

# Build Author
# Take care, it should be a universal and most probably, case-sensitive
AUTHOR="strongreasons"
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		git clone --depth=1 https://gitlab.com/strongreasons/stress-clang.git clang-llvm
		# Toolchain Directory defaults to clang-llvm
		TC_DIR=$KERNEL_DIR/clang-llvm
	fi

	msg "|| Cloning Anykernel ||"
	git clone --depth 1 --no-single-branch https://github.com/"$AUTHOR"/AnyKernel3.git -b hmp-12
