...
# Clone Kernel Source
git clone --depth=1 https://$USERNAME:$TOKEN@github.com/$USERNAME/Ruega-Kernel-X00T -b easus kernel
...
function zipping() {
    ...
    curl -sLo zipsigner-4.0.jar https://github.com/Magisk-Modules-Repo/zipsigner/raw/master/bin/zipsigner-3.0-dexed.jar
